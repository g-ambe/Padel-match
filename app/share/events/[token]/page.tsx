...
export default function SharedEventPage() {
  ...
  useEffect(() => { void (async () => {
    ...
    if (!normalizedToken) return setError("この共有リンクは無効です");
